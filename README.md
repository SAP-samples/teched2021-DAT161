...
### The systems of the hands-on exercise will be available until Friday November 19th 12:00 PM CET time and deleted afterwards!
...
- **[Deep Dive 1 - ABAP CDS View based data extraction in SAP Data Intelligence](exercises/dd1/)**
    ...
    - [Deep Dive 1.2 - Extraction and Delta enablement for simple ABAP CDS Views](exercises/dd1#deep-dive-12---extraction-and-delta-enablement-for-simple-abap-cds-views)
...
![](DAT161_Workshop_Scenarios.JPG)<br><br>
